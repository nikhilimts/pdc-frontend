...
const SingleExamMode = () => {
    ...
    const getSingleLastStatus = async () => {
        let a = await axios.get(`${apiUrl}/exam-mode/get-single-exam-mode/${Id}`);
        console.log(a.data);
        setValues(
            {
                Id: Id,
...
const n=useNavigate();
    ...
    const handleFormSubmit = async (e) => {
        ...
        let a = await axios.put(`${apiUrl}/exam-mode/update-exam-mode/${Id}`,
            values
        );
