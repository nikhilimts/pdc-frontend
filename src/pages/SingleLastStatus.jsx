...
const SingleLastStatus = () => {
    ...
    const getSingleLastStatus = async () => {
        let a = await axios.get(`${apiUrl}/last-status/get-single-last-status/${Id}`);
        console.log(a.data);
        setValues(
            {
                Id: Id,
                name: a.data.name,
                created_by: a.data.email
            }
        )
    ...
    const handleFormSubmit = async (e) => {
        ...
        let a = await axios.put(`${apiUrl}/last-status/Update-Last-Status/${Id}`,
            values
        );
...
export default SingleLastStatus;
