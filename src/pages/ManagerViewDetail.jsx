...
const ManagerViewDetails = () => {
    ...
    const getManagerDetail = async () => {
        let a = await axios.get(`${apiUrl}/manager/get-single-manager?Id=${id}`);
        console.log(a.data);
        setValues(a.data.manager);
        setValues(a.data.manager[0]);
        console.log("This is counsellors");
        console.log(a.data.counsellor);

        settabledata(a.data.counsellor);
            ...
            <div className="w-full -ml-16  flex-grow p-2">
                ...
                <div className="max-w-4xl mx-auto p-3 border border-gray-400 rounded-lg mt-2">
                 ...
                 flex justify-between items-center">
                        <h2 className="my-2 font-medium text-xl">Assign Responsible Person</h2>
                        <h2 className="my-2 font-medium text-xl">
                            Total Responsible Person: <span className="text-indigo-500">{tableDate.length}</span>
                        </h2>
                    </div>
                    <Table>
                        <TableCaption>A list of your assigned Responsible Person.</TableCaption>
                        <TableHeader>
                            <TableRow>
